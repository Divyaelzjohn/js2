...
/* 12j.Create an arrow function caleed 'multiply' that takes 2 numbers, multiplies them together , and returns the result.
-multiply(2,3)=>6
-multiply(7,10)=>70 */

/* 12k.COntinuing from exercise 12j, write the arrow function on one line(if you already did this , skip this exercise) */
/*
12i. Create a function countPositive(nums) that takes an array of numbers and returns how many numbers in the array are greater than 0. Create this function using . forEach() instead of a loop.
-countPositive([1,-3,5])=>2
-countPositive([-2,3,-5,7,10])=>3 */
/* 12m. Create a function addNum(array, num) that takes an array of numbers and returns an array where each number is incresed by 'num' . Create this function using .map() instead of a loop.
-addNum([1,2,3],2)=>[3,4,5]
-addNum([-2,-1,0,99],2)=>[0,1,2,101]
Bomnus: try to use the  one-line shortcut in your solution. */
/* 12n. Create a function removeEgg(foods) that takes an array of strings and returna an array where the string 'egg' is removed. Create this function using .filter() instead of a loop.
