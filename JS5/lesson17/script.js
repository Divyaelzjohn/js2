...
// class is better way to generate objects on OOP


// Lesson 17 Exercise -Object-oriented Programming (OOP)
...
• Create a race car { brand: McLaren', model: 'F1', acceleration:
20 } and try the code.*/
...
• In the products array, add type, instructionsLink, and warrantyLink to the toaster (4th product). If you need, download the images from: supersimple.dev/images/appliance-instructions.png supersimple.dev/images/appliance-warranty.png
...
/*Note: you may want to create a copy of the project code for exercise 17j. 17j. Replace all uses of the cart array with the cart class.
